CLASS lhc_Incident DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    CONSTANTS: BEGIN OF mc_status,
                 open        TYPE zde_status2_770 VALUE 'OP',
                 in_progress TYPE zde_status2_770 VALUE 'IP',
                 pending     TYPE zde_status2_770 VALUE 'PE',
                 completed   TYPE zde_status2_770 VALUE 'CO',
                 closed      TYPE zde_status2_770 VALUE 'CL',
                 canceled    TYPE zde_status2_770 VALUE 'CN',
               END OF mc_status.
...
CLASS lhc_Incident IMPLEMENTATION.
  ...
  METHOD get_instance_features.
    ...
    DATA lv_history_index TYPE zde_his_id_770.
...
* Declaration of necessary variables
    DATA: lt_updated_root_entity TYPE TABLE FOR UPDATE zr_dt_inct_770,
          ...
          lv_max_his_id          TYPE zde_his_id_770,
          lv_wrong_status        TYPE zde_status2_770.
...
** Fill history data
  ...
  METHOD validateDataRange.
    ...
    LOOP AT incidents INTO DATA(incident).
      "Manda mensaje de error en fecha de creación inicial
      IF incident-CreationDate IS INITIAL.
        APPEND VALUE #( %tky = incident-%tky ) TO failed-incident.
